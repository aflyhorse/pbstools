...
Group:  System Environment/Base
Requires:  perl,perl-DBD-MySQL,python3,python3-mysqlclient,pbsacct-python
...
%{python3_sitelib}/pbsacct-*
%{python3_sitelib}/pbsacct/__init__.py
%{python3_sitelib}/pbsacct/__pycache__/
